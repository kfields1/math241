...
ggplot(data = covid_survey_summary_stats, aes(x=mean, y = explanatory, xmin= low, xmax = high, color = explanatory_value)) +
  ...
  geom_text(aes(label = explanatory_value), 
            size = 3, color = "black") +
facet_grid(.~response, 
             labeller = labeller(response = c("resp_concern_safety" = "I am concerned about the safety and side effects of the vaccine", 
                              ...
                              "resp_trust_info" = "I trust the information that I have recieved about the vaccines",
