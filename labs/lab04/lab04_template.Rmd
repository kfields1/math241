...
ggplot(data = covid_survey_summary_stats %>% 
         mutate(explanatory = factor(explanatory,
                                     levels = c("NA", "exp_gender", "exp_race", "exp_ethnicity", "exp_profession", "exp_already_vax", "exp_flu_vax"),
                                     labels = c("All", "Gender", "Race", "Ethnicity", "Profession", "Had COVID vaccine", "Had flu vaccine"))),
         aes(x=mean, y = explanatory_value, xmin= low, xmax = high, color = explanatory_value)) +
