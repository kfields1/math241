...
ggplot(data = accidents, aes(x = time)) +
  geom_density(aes(fill=severity),alpha=.8) +
  facet_grid(daytype ~.) +
...
road_type, vehicles, severity, speed_limit
...
ggplot(data=accidents, aes(x=time, y = vehicles)) + 
  geom_point(aes(col=road_type, size=severity)) 
