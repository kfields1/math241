...
freedom <- read_csv("~/Rstudio/DataScience/math241repo/activities/freedom.csv", na = "-")
...
freedom_ranked %>%
  ...
  labs(
    ...
    title = "Australia's Civil Liberty Score over Time"
  ) +
...
# add code here
ggplot(data = freedom_to_plot, aes(x = Park)) + 
  geom_bar() +
